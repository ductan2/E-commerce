...
export const createContactController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(400).json({ error: error.message || "Create Contact failed", status: 400 })
  }
}
export const updateContactController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(error.status || 400).json({ error: error.message || "Update Contact failed", status: error.status || 400 })
  }
}
export const deleteContactController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(400).json({ error: error.message || "Delete Contact failed", status: 400 })
  }
}
export const getContactController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(400).json({ error: error.message || "Get Contact failed", status: 400 })
  }
}
export const getAllContactController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(400).json({ error: error.message || "Get all Contact failed", status: 400 })
  }
}
