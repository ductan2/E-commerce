...
export const createBlogController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(ErrorStatus.BAD_REQUEST).json({ error: error.message || "Create Blog failed", status: ErrorStatus.BAD_REQUEST })
  }
}
...
export const getBlogController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(error.status || ErrorStatus.BAD_REQUEST).json({ error: error.message || "Get Blog failed", status: error.status || ErrorStatus.NOT_FOUND })
  }
}
...
export const getAllBlogsController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(ErrorStatus.BAD_REQUEST).json({ error: error.message || "Get All Blogs failed", status: ErrorStatus.BAD_REQUEST })
  }
}
...
export const updateBlogController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(ErrorStatus.BAD_REQUEST).json({ error: error.message || "Update Blog failed", status: ErrorStatus.BAD_REQUEST })
  }
}
...
export const deleteBlogController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(ErrorStatus.BAD_REQUEST).json({ error: error.message || "Delete Blog failed", status: ErrorStatus.BAD_REQUEST })
  }
}
...
export const likesBlogController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(ErrorStatus.BAD_REQUEST).json({ error: error.message || "Likes Blog failed", status: ErrorStatus.BAD_REQUEST })
  }
}
...
export const disLikesBlogController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(ErrorStatus.BAD_REQUEST).json({ error: error.message || "Dislike Blog failed", status: ErrorStatus.BAD_REQUEST })
  }
}
