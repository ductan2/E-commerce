...
router.get("/info", auth_middlewares_1.authMiddlewares, users_controller_1.getInfoTokenController);
router.get("/refresh-token", users_controller_1.refreshTokenController);
router.get("/logout", auth_middlewares_1.authMiddlewares, users_controller_1.logoutController);
...
router.patch("/update-user", auth_middlewares_1.authMiddlewares, (0, validate_1.validate)(users_middlewares_1.UpdateValidator), (0, filter_middlewares_1.filterMiddleware)(["firstname", "lastname", "address", "mobile", "avatar"]), users_controller_1.updateUserController);
router.get('/wishlist', auth_middlewares_1.authMiddlewares, users_controller_1.getWishListController);
...
router.put('/update-user-address/:id_address', auth_middlewares_1.authMiddlewares, (0, filter_middlewares_1.filterMiddleware)(["address"]), users_controller_1.updateAddressUserController);
router.delete('/delete-user-address/:id_address', auth_middlewares_1.authMiddlewares, users_controller_1.deleteAddressUserController);
router.get('/cart/get-cart', auth_middlewares_1.authMiddlewares, users_controller_1.getUserCartController);
router.delete('/cart/delete-cart/:cart_id', auth_middlewares_1.authMiddlewares, users_controller_2.deleteCartController);
router.post('/order/cash-order', auth_middlewares_1.authMiddlewares, users_controller_1.createOrderController);
router.get('/order/get-order', auth_middlewares_1.authMiddlewares, users_controller_1.getOrderByUserController);
router.get('/order/get-order/:order_id', auth_middlewares_1.authMiddlewares, users_controller_1.getOrderController);
...
router.put('/cart/update-cart/:cart_id', auth_middlewares_1.authMiddlewares, (0, filter_middlewares_1.filterMiddleware)(["amount"]), users_controller_1.updateCartQuantityController);
